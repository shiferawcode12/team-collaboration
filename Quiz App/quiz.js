...
const quizArray = [
    {
        id: "0",
        question: "What is the language that most web pages are written in?",
        options: ["HTML", "HTTP", "URL", "BBS"],
        correct: "HTML",
    },
    {
        id: "1",
        question: "a program with a graphical user interface for displaying HTML files, used to navigate the World Wide Web?",
        options: [" search engine", "web browser", "comment", "textbox"],
        correct: "web browser",
    },
    {
        id: "2",
